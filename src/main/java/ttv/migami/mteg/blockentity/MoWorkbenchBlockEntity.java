package ttv.migami.mteg.blockentity;
...
import ttv.migami.jeg.blockentity.SyncedBlockEntity;
 ...
 * Author: MrCrayfish
 */
public class MoWorkbenchBlockEntity extends SyncedBlockEntity implements IStorageBlock
{
    private final NonNullList<ItemStack> inventory = NonNullList.withSize(1, ItemStack.EMPTY);

    public MoWorkbenchBlockEntity(BlockPos pos, BlockState state)
    {
        super(ModTileEntities.MO_WORKBENCH.get(), pos, state);
    }
    ...
    {
        return new TranslatableComponent("container.mteg.mo_workbench");
    }
    ...
    {
        return new MoWorkbenchContainer(windowId, playerInventory, this);
    }
}
