 ...
 * Author: MrCrayfish
 */
public class MoWorkbenchContainer extends AbstractContainerMenu
{
    private final MoWorkbenchBlockEntity workbench;
    private final BlockPos pos;

    public MoWorkbenchContainer(int windowId, Container playerInventory, MoWorkbenchBlockEntity workbench)
    {
        super(ModContainers.MO_WORKBENCH.get(), windowId);
        this.workbench = workbench;
        this.pos = workbench.getBlockPos();

        int offset = MoWorkbenchRecipes.isEmpty(workbench.getLevel()) ? 0 : 28;
    ...
    public MoWorkbenchBlockEntity getWorkbench()
    {
        return workbench;
    }
