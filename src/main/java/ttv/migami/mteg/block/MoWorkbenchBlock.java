...
import ttv.migami.jeg.block.RotatedObjectBlock;
 ...
 * Author: MrCrayfish
 */
public class MoWorkbenchBlock extends RotatedObjectBlock implements EntityBlock
{
    private static final VoxelShape SHAPE = makeShape();

    public MoWorkbenchBlock(Properties properties)
    {
        super(properties);
    }
    ...
    {
        return new MoWorkbenchBlockEntity(pos, state);
    }
}
